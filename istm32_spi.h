...
#include "timings.h" //rename to timing not timingS
...
public:
	...
	Status getTemp(float& out_celsius) noexcept;
	Status getPress(float& out_pascal) noexcept;
...
private:
	...
	Status readRegister8(Register reg, uint8_t& out_value) const noexcept;//All into static functions instead?
